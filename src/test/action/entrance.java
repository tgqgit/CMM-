...
public class entrance {
    ...
    public String compile(String path) {
        ...
        //源文件的txt的处理
//        String pathname = "src/语法测试(错误).txt";
        ...
        if (lexerPoint == 0) {
            ...
            if (parser.elseError == 1) {
                ...
                presentCon = lexerError + "程序语法无误！\n";
                if (parserError != "") {
                    System.out.println(parserError);
                    System.out.println("程序语义有误！\n");
                    presentCon = presentCon + parserError + "程序语义有误！\n";
                } else {
                    presentCon = presentCon + "程序语义无误！\n";
                }
            } else {
                System.out.println("程序语法有误!\n");
                //entrance.parserResult = entrance.parserResult + "程序语法有误！\n";
                System.out.println(parserError);
                presentCon = lexerError + "程序语法有误!\n" + parserError;
